...
export const stacksToMicro = (amountInStacks: string | number): string | number =>
 ...
 */
 ...
 export const microToTokens = (
  amountInMicroTokens: string | number,
 ...
 */
 ...
 export const tokensToMicro = (amountInTokens: string | number, decimals: string | number): string | number =>
  amountInTokens ? Math.floor(Number(amountInTokens) * Math.pow(10, parseInt(decimals.toString()))) : 0;