...
exports.splitContractAddress = exports.truncateAddress = exports.shortenAddress = exports.validateContractAddress = exports.validateStacksAddress = void 0;
...
const validateContractAddress = (contractAddress) => {
    ...
    try {
        const validStacksAddress = (0, exports.validateStacksAddress)(stxAddress);
 ...
 */
const truncateAddress = (input, offset = 5) => {
    var _a, _b;
    if (!input)
        return '';
 ...
 */
const splitContractAddress = (address) => {
    if (!address)
        return [];
    return address === null || address === void 0 ? void 0 : address.split('.');
};
exports.splitContractAddress = splitContractAddress;
